...
Production high-flow case:
    dt = 0.00025 s
    T  = 1000 s

This file starts from quiescent salt water if no checkpoint from THIS
70 cc/min calculation exists. It never reads the old 20 cc/min run.
If restarted, it resumes only from a checkpoint created by this case.
"""
...
OUTPUT_FOLDER = (
    "/user/work/kn22417/"
    "output_axisym_70ccmin_oseen_dt00025_1000s"
)

dt_value = 0.001

# 1000 s physical duration.
T_final = 1000.0
...
if latest_checkpoint is not None:
    ...
    if rank == 0:
        ...
        print("High-flow timestep chosen to preserve the")
        print("validated 20 cc/min advective stability margin.")
