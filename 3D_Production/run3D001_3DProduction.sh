...
#SBATCH --chdir=/user/home/kn22417/3DProduction
#SBATCH --output=/user/home/kn22417/3DProduction/fenics3D001_monitored_%j.out
#SBATCH --error=/user/home/kn22417/3DProduction/fenics3D001_monitored_%j.err

# Production directory fixed to the location used by the successful
# restart diagnostic (job 18897197): /user/home/kn22417/3DProduction
#
...
#   sbatch /user/home/kn22417/3DProduction/run3D001_monitored_fixed.sh
#
...
PRODUCTION_DIR="/user/home/kn22417/3DProduction"
cd "$PRODUCTION_DIR" || {
