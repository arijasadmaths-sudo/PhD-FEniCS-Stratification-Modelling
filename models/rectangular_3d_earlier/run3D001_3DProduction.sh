...
#SBATCH --chdir=/path/to/home/3DProduction
#SBATCH --output=/path/to/home/3DProduction/fenics3D001_monitored_%j.out
#SBATCH --error=/path/to/home/3DProduction/fenics3D001_monitored_%j.err

# Production directory fixed to the location used by the successful
# restart diagnostic (job 18897197): /path/to/home/3DProduction
#
...
#   sbatch /path/to/home/3DProduction/run3D001_monitored_fixed.sh
#
...
PRODUCTION_DIR="/path/to/home/3DProduction"
cd "$PRODUCTION_DIR" || {
