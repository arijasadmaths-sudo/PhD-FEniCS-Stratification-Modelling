...
extra_fine_half (200736 cells, dt=.0005; new launcher pauses at 5 s).
...
def parse_args():
    ...
    p.add_argument("--case", choices=("coarse", "fine", "fine_half", "extra_fine", "fine_quarter", "extra_fine_half"))
    ...
    dt_value = {"fine_half": 0.0005, "fine_quarter": 0.00025, "extra_fine_half": 0.0005}.get(args.case, 0.001)
...
CASE = {"refinement": {"coarse": 1, "fine": 2, "fine_half": 2,
                       "extra_fine": 4, "fine_quarter": 2, "extra_fine_half": 4}[CASE_NAME]}
...
try:
    ...
    dt_value = {"fine_half": 0.0005, "fine_quarter": 0.00025, "extra_fine_half": 0.0005}.get(CASE_NAME, 0.001)
