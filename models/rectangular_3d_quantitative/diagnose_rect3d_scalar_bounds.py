# ISOLATED SCALAR BOUNDS DIAGNOSTIC: exactly 50 steps, never a study continuation.
...
from rect3d_bounds_report import BoundsReport
...
for _key, _value in {
    ...
    "T_GLOBAL": "0.05", "SEGMENT_DURATION": "0.05",
...
requested_output_root = "diagnostic_rect3d_bounds_" + diagnostic_job_tag
...
root_print("")
root_print("================================================")
root_print("STARTING ISOLATED 50-STEP SCALAR BOUNDS DIAGNOSTIC")
root_print("================================================")
root_print("dt                 =", dt)
...
if completed_step < max_global_step:
    ...
    root_print("")
    root_print("50-STEP DIAGNOSTIC HORIZON REACHED.")
